  ...
  switch (level) {
    case 1:
      return (
        <h1
          className={cn(
            `scroll-m-20 font-heading font-inter text-4xl font-bold tracking-tig ht dark:text-white`,
            className,
          )}
        >
          {children}
    ...
    case 2:
      return (
        <h2
          className={cn(
            `scroll-m-20 pb-2 font-heading text-[32px] font-semibold tracking-tight transition-colors first:mt-0`,
            className,
          )}
        >
          {children}
